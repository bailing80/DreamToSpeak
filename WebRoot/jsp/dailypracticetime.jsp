...
<body
	background="${pageContext.request.contextPath }/static/image/dailypracticetime.png"
	style="background-repeat: no-repeat; background-size: 100% 100%; background-attachment: fixed">
	<h3
		style="color: #ffff00; font-size: 50px; margin-left: 300px; margin-top: 100px;">当天练习的时长</h3>
	<img style="vertical-align: bottom" />
	<input type="text "
		style="font-size: 30px; width: 530px; height: 500px; margin-left: 230px; margin-top: 35px;"
