...
<body class="no-skin">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<tr>
									<td style="width:150px;" class="center">
									<button class="btn btn-app btn-purple btn-xs" onclick="proHome6();">
												<i class="ace-icon fa fa-print bigger-160"></i>
									</button>
									</td>
									<td style="padding-top: 12px;">
										<h4 class="green smaller lighter">生成页面(模版6为单页风格)</h4>
									</td>
									<td style="padding-top: 12px;" colspan="10" class="center">
										<h4 class="green smaller lighter">
											<b>
	...
	<script type="text/javascript">
		...
		function setMoban(value){
			...
			$.ajax({
				...
				success: function(data){
					top.hangge();
					if("createHtml6" == value){
						proHome6(); 	//模版6是单页形式网站，只生成首页即可
					}else{
						proAll();
					}
				}
		...
		function proHome6(){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>createHtml/proHome6.do',
		    	data: {tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
