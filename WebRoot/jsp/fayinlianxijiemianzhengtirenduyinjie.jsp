...
<script>
				...
				for(var i=0;i<sms.length;i++){
					if(text.value==sms[i]){
						if(i==sms.length-1){
							...
							nextV=sms[i+1];
							location.href = "fayinlianxijiemianzhengtirenduyinjie2.jsp?ztrdyj=" + nextV;
							return;
						}
					}
				}
			...
			function load() {
				...
				video.innerHTML="<embed src='${pageContext.request.contextPath }/static/video/zhengtirenduyinjie/"+ztrdyj+".mp4' style='width:280px;height:280px;position:absolute;top:20px;left:250px;'></embed>";
			}
		</script>
<style>
.a {
