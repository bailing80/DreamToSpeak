...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(static)|(main)|(websocket)|(fhadmin)|(web)|(fh_static_1)|(fh_static_2)|(fh_static_3)|(fh_static_4)|(fh_static_5)|(fh_static_6)|(ueditor)|(index)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
